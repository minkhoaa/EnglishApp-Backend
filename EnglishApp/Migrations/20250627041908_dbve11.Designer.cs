...
namespace EnglishApp.Migrations
{
    ...
    [Migration("20250627041908_dbve11")]
    partial class dbve11
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnglishApp.Data.ExamCategory", b =>
                {
                    b.Property<int>("ExamCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ExamCategoryId"));
            ...
            modelBuilder.Entity("EnglishApp.Data.UserExamResult", b =>
                {
                    b.Property<int>("UserExamResultId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("UserExamResultId"));
                    ...
                    b.ToTable("userexamresults", (string)null);
                });
            ...
            modelBuilder.Entity("EnglishApp.Data.WritingExamContent", b =>
                {
                    ...
                    b.ToTable("writingexamcontent", (string)null);
                });
            ...
            modelBuilder.Entity("EnglishApp.Data.WritingTest", b =>
                {
                    ...
                    b.ToTable("writingtest", (string)null);
                });
            ...
            modelBuilder.Entity("EnglishApp.Data.Exam", b =>
                {
                    b.HasOne("EnglishApp.Data.ExamCategory", "Category")
                        .WithMany("Exams")
            ...
            modelBuilder.Entity("EnglishApp.Data.UserExamResult", b =>
                {
                    b.HasOne("EnglishApp.Data.ExamOption", "AnswerOption")
            ...
            modelBuilder.Entity("EnglishApp.Data.WritingExamContent", b =>
                {
                    b.HasOne("EnglishApp.Data.WritingTest", "Tests")
                        .WithOne("ExamContent")
                        .HasForeignKey("EnglishApp.Data.WritingExamContent", "ExamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
